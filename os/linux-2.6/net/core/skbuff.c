...
#if defined(CONFIG_LINUX_SKB_REUSE_BCM9636X)
/**
 *  
    ...
    struct blog_t * blog_p)
{
	...
	skb->end  = (unsigned char *) (((unsigned long) data + datalen + 0x0f) & ~0x0f);
	skb->len = datalen;
...
#elif defined(CONFIG_LINUX_SKB_REUSE_BCM9636X)
		/*
...
static inline void __kmem_cache_free_skb(struct kmem_cache *cachep,
    struct sk_buff *skb)
{
#ifdef CONFIG_LINUX_SKB_REUSE
	/*
...
static void copy_skb_header(struct sk_buff *new, const struct sk_buff *old)
{
	...
	new->recycle_context = 0;
	new->recycle_flags &= SKB_DATA_NO_RECYCLE & SKB_NO_RECYCLE;
#endif
#ifdef CONFIG_OPENRG

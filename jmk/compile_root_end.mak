...
_GET_COMPILER=$(call DBGFR, \
  $(if $(is_local_obj_$(call Abs_Path_To_Var,$2)), \
    $(CC_FOR_BUILD), \
    $(if $(is_mod_obj_$(call Abs_Path_To_Var,$2))$(filter $2,$(sav_JMK_TARGET_CC_OBJS)), \
      $(TARGET_CC), \
...
Get_Obj_Source=\
  ...
  $(if $(filter $(ALL_LOCAL_OBJS),$1), \
    ...
    $(or \
      ...
      $(call Wildcard_Src,$(O_ROOT_PATH),_mod_3X.o=.c), \
      $(call Wildcard_Src,$1,_mod_3X.o=.c), \
      ...
      $(call Wildcard_Src,$(O_ROOT_PATH),_mod_3X.o=.cpp), \
      $(call Wildcard_Src,$1,_mod_3X.o=.cpp), \
      ...
      $(call Wildcard_Src,$(O_ROOT_PATH),_mod_3X.o=.cxx), \
      $(call Wildcard_Src,$1,_mod_3X.o=.cxx), \
      $(call Wildcard_Src,$(O_ROOT_PATH),_mod_26.o=.cxx), \
      $(call Wildcard_Src,$1,_mod_26.o=.cxx), \
      $(call Wildcard_Src,$(O_ROOT_PATH),.o=.cc), \
      $(call Wildcard_Src,$1,.o=.cc), \
      $(call Wildcard_Src,$(O_ROOT_PATH),_mod_3X.o=.cc), \
      $(call Wildcard_Src,$1,_mod_3X.o=.cc), \
      ...
      $(call Wildcard_Src,$(O_ROOT_PATH),_mod_3X.o=.S), \
      $(call Wildcard_Src,$1,_mod_3X.o=.S), \
      $(call Wildcard_Src,$(O_ROOT_PATH),_mod_26.o=.S), \
      $(call Wildcard_Src,$1,_mod_26.o=.S), \
      $(wildcard $(O_ROOT_PATH).$(TARGET_MACHINE)*), \
      $(filter $(1:.o=.c) $(1:_mod_3X.o=.c) $(1:_mod_26.o=.c) $(1:.o=.cpp) \
        $(1:_mod_3X.o=.cpp) $(1:_mod_26.o=.cpp) $(1:.o=.cxx) \
	$(1:_mod_3X.o=.cxx) $(1:_mod_26.o=.cxx) $(1:.o=.cc) $(1:_mod_3X.o=.cc) \
	$(1:_mod_26.o=.cc) $(o:_pic.o=.c) $(1:_pic.o=.cpp) $(1:_pic.o=.cxx) \
	$(1:_pic.o=.cc) $(1:.o=.S) $(1:_mod_3X.o=.S) $(1:_mod_26.o=.S), \
	$(sav_JMK_AUTOGEN_SRC))))
...
ifdef CONFIG_RG_OS_LINUX
  ...
  ifdef CONFIG_RG_OS_LINUX_3X
    # newer kernels sort symbols within __ksymtab with the below ld script
    MOD_LDFLAGS=-T $(JMK_ROOT)/os/linux-3.x/scripts/module-common.lds
  endif

$(sav_JMK_MOD_TARGET):
	@# compile kext_mod.o for all modules (override RG_COMPILE_FUNC with exact cflags)
	$(if $(sav_JMK_JPKG_TARGET_$(call Abs_Path_To_Var,$@)), \
	  $(if $(filter $@,$(sav_JMK_MOD_2_STAT) $(sav_JMK_MOD_O_TARGET)),, \
	    $(JMKE_LN) $(JMK_ROOT)/pkg/util/kext_mod.c $(basename $@).mod.c && \
	    $(TARGET_CC) \
	      $(sav_JMK_RG_LINUX_CFLAGS_$(call Abs_Path_To_Dir_Var,$@)) \
	      $(sav_JMK_MOD_CFLAGS_$(call Abs_Path_To_Dir_Var,$@)) \
	      $(if $(CONFIG_RG_OS_LINUX_26),$(call GET_MOD_LINUX_CFLAGS,$@,26)) \
	      $(if $(CONFIG_RG_OS_LINUX_3X),$(call GET_MOD_LINUX_CFLAGS,$@,3X)) \
	      -DMODULE -c -o $(basename $@).mod.o $(basename $@).mod.c))
	$(if $(sav_JMK_JPKG_TARGET_$(call Abs_Path_To_Var,$@)), \

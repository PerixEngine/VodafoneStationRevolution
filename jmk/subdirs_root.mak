...
dir_target_objs=JMK_O_OBJS JMK_OX_OBJS JMK_L_OBJS JMK_sO_OBJS \
  JMK_MOD_3X_O_OBJS JMK_MOD_26_O_OBJS JMK_LIBS JMK_LOCAL_LIBS \
...
dir_export_vars=JMK_EXPORT_HEADERS_DIR JMK_EXPORT_HEADERS_FLAT \
  JMK_EXPORT_HEADERS JMK_EXPORT_RG_LINUX_HEADERS
...
global_src_objs=JMK_JS_FILES JMK_CSS_FILES JMK_SCSS_FILES JMK_SQL_FILES \
  ...
  cp_JMK_EXPORT_RG_LINUX_HEADERS

global_ramdisk_objs=JMK_RAMDISK_FILES JMK_RAMDISK_BIN_FILES \
  JMK_RAMDISK_ETC_FILES JMK_RAMDISK_LIB_FILES \
  ...
  JMK_RAMDISK_DIRS JMK_RAMDISK_CGI_FILES
...
global_objs=$(global_ramdisk_objs) JMK_MOD_2_STAT JMK_CLEAN JMK_AUTOGEN_SRC \
  ...
  JMK_A_TARGET_PIC JMK_TARGET_CC_OBJS
...
per_target_obj_prefixes=JMK_O_OBJS_ JMK_OX_OBJS_ JMK_L_OBJS_ \
  JMK_MOD_3X_O_OBJS_ JMK_MOD_26_O_OBJS_ JMK_LIBS_ JMK_OSAP_MODULE_COMPONENTS_ \
...
global_obj_prefixes=JMK_DLM_FILES_ JMK_DLM_BIN_FILES_ JMK_DLM_ETC_FILES_ \
  ...
  JMK_DLM_DPKG_FILES_ JMK_DLM_SIGNED_FILES_ 

...
typedef enum {
    ...
    LOG_ENTITY_USB_MNG = 835,
    LOG_ENTITY_CSG = 840,
    LOG_ENTITY_FASTPATH = 850,
    LOG_ENTITY_3G = 860,
    LOG_ENTITY_3G_NCM = 861,
    LOG_ENTITY_DECT = 870,
    LOG_ENTITY_WAN_AUTO_DETECT = 880,
    LOG_ENTITY_WAN_MODE = 885,
    LOG_ENTITY_VODAFONE_LCD = 890,
    LOG_ENTITY_HW_BUTTONS = 900,
    LOG_ENTITY_TWONKY = 910,
    LOG_ENTITY_EASY_MANAGEMENT = 920,
    LOG_ENTITY_PLUGINS = 1000,
    LOG_ENTITY_DLM = 1010,
    LOG_ENTITY_VODAFONE_REMOTE_ACCESS = 1020,
    LOG_ENTITY_ISDND = 1030,
    LOG_ENTITY_CWMP_IPC = 1040,
    LOG_ENTITY_REMOTE_FILE_ACCESS = 1050,
    LOG_ENTITY_TTY_MGR = 1060,
    LOG_ENTITY_LLDP_RX = 1070,
    LOG_ENTITY_LTE = 1080,
    LOG_ENTITY_VODAFONE_ACTIVATION_WIZARD = 1090,
    /* Project tailored categories: */
    LOG_ENTITY_PROJ_SYSTEM = 1100,
    LOG_ENTITY_PROJ_WAN = 1101,
    LOG_ENTITY_PROJ_LAN = 1102,
    LOG_ENTITY_PROJ_VOICE = 1103,
    LOG_ENTITY_PROJ_DATA = 1104,
    LOG_ENTITY_PROJ_ACS = 1105,
    LOG_ENTITY_PROJ_UMTS = 1106,
    LOG_ENTITY_PROJ_USB = 1107,
    LOG_ENTITY_PROJ_FIREWALL = 1108,
    LOG_ENTITY_PROJ_IPTV = 1109,
    LOG_ENTITY_WEBDAV = 1120,
    LOG_ENTITY_ALARM_CLOCK = 1130,
    LOG_ENTITY_VSAF = 1140,
    /* Statistics */
    ...
    /* Network statistics */
    LOG_ENTITY_NET_STATS = 3005,
     /* Emaze*/
    LOG_ENTITY_EMAZE_DEAMON = 3010,
    LOG_ENTITY_OTHER = 3020, /* Other entities */
    /* Sensors */
    LOG_ENTITY_PROXIMITY = 3030,
    /* FON */
    LOG_ENTITY_FON = 4000,
    LOG_ENTITY_VF_WL_CHAN_RESCAN = 4010,
} log_entity_id_t;

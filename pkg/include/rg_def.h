...
#define SSID_NAME_PREFIX VODAFONE_NAME
#define SSID_NAME_PREFIX_SEP SSID_NAME_PREFIX "-"
...
#define GUEST_SSID SSID_NAME_PREFIX_SEP "Guest"

/* UPNP */
#ifdef CONFIG_RG_VODAFONE_2_5
#ifdef CONFIG_RG_VODAFONE_UK
#define UPNP_MODEL_NAME "Revolution"
#define UPNP_DEVICE_TITLE VODAFONE_NAME " Connect"
#else
#define UPNP_MODEL_NAME "Revolution"
#define UPNP_DEVICE_TITLE VODAFONE_NAME " Station"
#endif
#define UPNP_DEVICE_MANUFACTURER VODAFONE_NAME
#define UPNP_MANUFACTURER_URL "http://www.vodafone.com"
#else
#define UPNP_MODEL_NAME "OpenRG_IGD"
#define UPNP_DEVICE_TITLE JUNGO_NAME " OpenRG Internet Gateway Device"
#define UPNP_DEVICE_MANUFACTURER JUNGO_NAME
#define UPNP_MANUFACTURER_URL JUNGO_URL
#endif
...
#define SYSTEM_PRIO_BIT (1 << 24)
#define SYSTEM_SET_PRIO(nice) (SYSTEM_PRIO_BIT | (((nice)+20) << 25))
#define SYSTEM_GET_NICE(flags) ((((flags) >> 25) & 0x3f) - 20)

#define MAX_BAD_REBOOT 3
#define IGNORE_BAD_REBOOTS -1
 ...
 * seconds (6 LCP echo requests will be sent every 5 secconds)
 */
#define DEFAULT_PPP_ECHO_PERIOD 5
#define DEFAULT_PPP_ECHO_RETRY 6
#define DEFAULT_MAX_MRU 1500
/* Vodafone Spain spec. request */
#define MIN_PPP_ECHO_PERIOD 1
#define MAX_PPP_ECHO_PERIOD 10
#define MIN_PPP_ECHO_RETRY 2
#define MAX_PPP_ECHO_RETRY 12
...
#define CUSTOM_RULES_DESCR "Custom firewall rules"
#define MAC_FILTER_DESCR "MAC filter rules"
#define ACC_CTRL_BLOCK_RULES_DESCR "Access Control - Block"
#define ACC_CTRL_ALLOW_RULES_DESCR "Access Control - Allow"
#define ACC_CTRL_RULES_DESCR "Access Control (Parental Control)"
/* Parental control time rule for the wireless interface */
#define PC_WIFI_RULE_DESCR "Wireless interface (Parental Control)"
...
#define GRP_GUEST_SSID		"guest_ssid" 
#define GRP_RATE_CHECKS_IN	"grp_rate_checks" 
#define GRP_SECURITY_UDP_DOS_PROTECTION	"udp_dos_protection" 
...
#define GRP_RESTRICTED_LAN      "restricted_lan"
...
#define GRP_CUSTOM_RULES        "custom_rules"
#define GRP_CUSTOM_RULES_STUB   "custom_rules_stub"
#define GRP_MAC_FILTER          "mac_filter"
#define GRP_STATIC_NAT_IN       "static_nat_in"
#define GRP_STATIC_NAT_OUT      "static_nat_out"
#define GRP_INTERCEPTION_NAT_IN "interception_nat_in"
#define GRP_VOIP_TEMPLATE_EXT   "voip_template_ext"
...
#define GRP_EMAZE_PXY           "emaze_pxy"
...
#define GRP_PARENTAL_CTRL_VF    "parental_ctrl_vf"
#define GRP_ACCESS_CTRL_VF      "access_ctrl_vf"
#define GRP_ACCESS_CTRL_VF_STUB   "access_ctrl_vf_stub"

/* hybrid model chain */
#define BRIDGE_FILTER_CHAIN 	"bridge_filter_chain"

/* QoS chains*/
#define QOS_CHAIN_PREFIX "qos"
...
#define QOS_CHAIN_HIGH_PRI "qos_high_pri"
...
#define HTTP_VAR_JS "js"
#define HTTP_VAR_PAGE "page"

/* Disk management definitions */
#define GUEST_USER_ID -1
#define DISK_MAX_DEV_NAME_LEN	 64
#define DISK_MOUNT_POINT_BASE	 "/mnt/fs"
#define SAMBA_MOUNT_POINT_BASE "/mnt/samba"
#define SAMBA_MOUNT_POINT_BASE_USER SAMBA_MOUNT_POINT_BASE "/%u"
#define DISK_FTP_MOUNT_POINT_BASE "/mnt/ftp"
#define DISK_FTP_WAN_MOUNT_POINT_BASE "/mnt/ftp_wan"
#define DISK_MAX_FTP_MOUNT_POINT_LEN \
    (sizeof(DISK_FTP_MOUNT_POINT_BASE) + DISK_MAX_DEV_NAME_LEN)
...
#define URL_FILTER_INTERCEPT_IP 0x01010102 /* 1.1.1.2, host order */
#define DNS_ALIASING_POOL_START_IP "1.1.1.3"
#define DNS_ALIASING_POOL_END_IP "1.1.1.222"

/* HTTP Reverse Proxy */
#define REVERSE_PROXY_POOL_START_IP 0x010101DF /* 1.1.1.223, host order */
#define REVERSE_PROXY_POOL_END_IP 0x010101FF /* 1.1.1.255, host order */
#define HTTP_REVERSE_PROXY_PORT 7889
...
#define HTTP_HOME_DIRECTORY "/home"
#define HTTP_HTTPD_DIRECTORY HTTP_HOME_DIRECTORY "/httpd"
#define HTTP_WBM_DIRECTORY "/var/lib/wbm"
#if defined(CONFIG_RG_JNET_SERVER)
#define HTTP_DEFAULT_DIRECTORY "/usr/local/jnet"
#else
#define HTTP_DEFAULT_DIRECTORY HTTP_HTTPD_DIRECTORY "/html"
#endif

...
#define ipsec_dev_get(x) __dev_get_by_name(&init_net, x)
#else
...
/*
 * $Log: ipsec_param.h,v $
 * Revision 1.5.4.1  2015/07/15 13:15:30  itamarh
 * AUTO MERGE: branch-5_4_8_1 <- branch-5_4_8_1_236_1
 * B191157 Fix dev_get_by_name in freeswan for linux-3.x
 * NOTIFY: automerge
 *
 * Revision 1.5.2.1  2015/07/15 13:15:19  itamarh
 * B191157 Fix dev_get_by_name in freeswan for linux-3.x
 *

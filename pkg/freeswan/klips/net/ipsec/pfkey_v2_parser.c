...
char pfkey_v2_parser_c_version[] = "$Id: pfkey_v2_parser.c,v 1.26.4.2 2015/07/13 16:12:45 itamarh Exp $";
...
#ifdef CONFIG_IPSEC_ALG_JOINT_FEATURE
...
#ifndef CONFIG_IPSEC_USE_IXP4XX_OLD_CRYPTO
...
# ifdef CONFIG_IPSEC_AUTH_HMAC_SHA1
		...
		if (ixt_j && ixt_j->ixt_j_is_support_ah_proto)
		{
		        if ((error=ipsec_alg_joint_key_create(tdbp)))
			        SENDERR(-error);
		}
		else
#endif /* CONFIG_IPSEC_ALG */

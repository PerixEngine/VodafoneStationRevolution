...
#define RTP_SO_MARK_SET _IOW(RG_IOCTL_PREFIX_RTP, 10, u32)
#define RTP_RTCP_SET_INTERVAL _IOW(RG_IOCTL_PREFIX_RTP, 11, u32)
#define RTP_ADDRS_GET _IOR(RG_IOCTL_PREFIX_RTP, 12, rtp_addrs_t)
#define RTP_SECS_SINCE_LAST_RTP_GET _IOR(RG_IOCTL_PREFIX_RTP, 13, u32)
...
void rtp_media_use(void *rtp_context);
void rtp_media_put(void *rtp_context);
#endif
...
typedef struct {
    ...
    u32 so_mark; /* Mark socket with SO_MARK */
    int rtcp_enable;
} rtp_ioctl_new_t;
...
typedef struct rtp_stats_t{
    ...
    u32 avg_rx_jitter; /* in timestamp units */
    u32 avg_reported_jitter; /* in timestamp units */
    u32 round_trip_delay; /* in 1/65536 seconds units */
    u32 avg_round_trip_delay; /* average of round trip delay */
    u32 rx_fraction_sum;
    u32 tx_fraction_sum;
    u32 num_of_rtcp_sent;
    u32 num_of_rtcp_received;
} rtp_stats_t;

...
/* This function works like ast_app_getdata only escape codes and breake_keys was added 
...
*     0 if user dialed '#' or a character from "break_keys"
...
*/
extern int ast_app_getdata_allow_escape(struct ast_channel *c, char *prompt, char *s, int maxlen, int timeout, char *escape_code, int escape_timeout, char *break_keys);
...
/*! Set/Unset remote message flag for mailbox */

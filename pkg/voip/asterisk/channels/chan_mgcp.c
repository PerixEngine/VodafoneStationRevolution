...
ASTERISK_FILE_VERSION(__FILE__, "$Revision: 1.11.2.1 $")
...
static struct ast_rtp *mgcp_get_rtp(struct ast_channel *ast);
...
static struct ast_rtp *mgcp_get_rtp(struct ast_channel *chan)
{

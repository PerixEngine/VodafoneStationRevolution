...
ASTERISK_FILE_VERSION(__FILE__, "$Revision: 1.6.2.1 $")
...
static int txt_callback(void *context, char *answer, int len, int ttl, char *fullanswer)
{
...
static int enum_callback(void *context, char *answer, int len, int ttl, char *fullanswer)
{
	struct enum_context *c = (struct enum_context *)context;
       void *p = NULL;
       int res;
